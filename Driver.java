...
public class Driver {
	...
	public static void main(String[] args) 
	{
		while(true)
		{
			...
			secondDestArray = sourceArray.clone();
			
			SelectionSort(sourceArray);
			BubbleSort(destArray);
			InsertionSort(secondDestArray);
	...
	public static void InsertionSort(int[] arr) 
	{
		...
		System.out.println("InsertionSort sorted an array of " + arr.length + " in " + timeElapsed + "ns.");
	}
